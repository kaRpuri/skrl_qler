# filepath: /skrl_f1tenth_pipeline/skrl_f1tenth_pipeline/src/skrl_qler/gym_model.py

"""
This file integrates the end-to-end pipeline for the F1Tenth gym environment using the SKRL framework.
It combines the model architecture from train.py with the environment setup and training logic.
"""
...
from train import SpatioTempDuelingTransformerNet
from gym_interface import LidarEnv, create_lidar_sequences, load_all
